 ...
 * @author Arsiela
 */
public class Model_Parts_Bin implements GEntity {

    final String XML = "Model_Parts_Bin.xml";
     ...
     */
    public Model_Parts_Bin(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Parts_Bin loOldEntity = new Model_Parts_Bin(poGRider);
