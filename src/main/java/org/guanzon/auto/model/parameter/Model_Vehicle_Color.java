 ...
 * @author Arsiela
 */
public class Model_Vehicle_Color implements GEntity {

    final String XML = "Model_Vehicle_Color.xml";
     ...
     */
    public Model_Vehicle_Color(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setColorID(MiscUtil.getNextCode(getTable(), "sColorIDx", false, poGRider.getConnection(), poGRider.getBranchCode()+"CL"));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Vehicle_Color loOldEntity = new Model_Vehicle_Color(poGRider);
