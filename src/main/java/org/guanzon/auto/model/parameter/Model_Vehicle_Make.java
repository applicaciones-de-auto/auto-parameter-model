 ...
 * @author Arsiela
 */
public class Model_Vehicle_Make implements GEntity {

    final String XML = "Model_Vehicle_Make.xml";
     ...
     */
    public Model_Vehicle_Make(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setMakeID(MiscUtil.getNextCode(getTable(), "sMakeIDxx", false, poGRider.getConnection(), poGRider.getBranchCode()+"MK"));
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, " sMakeIDxx = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Vehicle_Make loOldEntity = new Model_Vehicle_Make(poGRider);
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    ...
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sMakeIDxx = " + SQLUtil.toSQL(this.getMakeID()));
     ...
     * @return result as success/failed
     */
    public JSONObject setMakeCode(String fsValue) {
        return setValue("sMakeCode", fsValue);
    }
    ...
    public String getMakeCode() {
        return (String) getValue("sMakeCode");
    }
     ...
     * @return result as success/failed
     */
    public JSONObject setFormula1(String fsValue) {
        return setValue("sFormula1", fsValue);
    }
    ...
    public String getFormula1() {
        return (String) getValue("sFormula1");
    }
     ...
     * @return result as success/failed
     */
    public JSONObject setFormula2(String fsValue) {
        return setValue("sFormula2", fsValue);
    }
    ...
    public String getFormula2() {
        return (String) getValue("sFormula2");
    }
