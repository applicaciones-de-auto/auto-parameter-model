 ...
 * @author Arsiela
 */
public class Model_Parts_Warehouse implements GEntity {

    final String XML = "Model_Parts_Warehouse.xml";
     ...
     */
    public Model_Parts_Warehouse(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Parts_Warehouse loOldEntity = new Model_Parts_Warehouse(poGRider);
