 ...
 * @author Arsiela
 */
public class Model_Vehicle_Type implements GEntity {

    final String XML = "Model_Vehicle_Type.xml";
     ...
     */
    public Model_Vehicle_Type(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setTypeID(MiscUtil.getNextCode(getTable(), "sTypeIDxx", false, poGRider.getConnection(), poGRider.getBranchCode()+"TP"));
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, " sTypeIDxx = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        String lsExclude = "sVhclSize»sVarianta»sVariantb»sMakeDesc»sMakeIDxx";
        poJSON = new JSONObject();
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Vehicle_Type loOldEntity = new Model_Vehicle_Type(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getTypeID());

                if ("success".equals((String) loJSON.get("result"))) {
                    setModified(poGRider.getUserID());
                    setModifiedDte(poGRider.getServerDate());
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sTypeIDxx = " + SQLUtil.toSQL(this.getTypeID()), lsExclude);
     ...
     * @return result as success/failed
     */
    public JSONObject setTypeCode(String fsValue) {
        return setValue("sTypeCode", fsValue);
    }
    ...
    public String getTypeCode() {
        return (String) getValue("sTypeCode");
    }
    ...
    public JSONObject setVhclSize(String fsValue) {
        return setValue("sVhclSize", fsValue);
    }
    ...
    public String getVhclSize() {
        return (String) getValue("sVhclSize");
    }
     ...
     * @return result as success/failed
     */
    public JSONObject setVarianta(String fsValue) {
        return setValue("sVarianta", fsValue);
    }
    ...
    public String getVarianta() {
        return (String) getValue("sVarianta");
    }
     ...
     * @return result as success/failed
     */
    public JSONObject setVariantb(String fsValue) {
        return setValue("sVariantb", fsValue);
    }
    ...
    public String getVariantb() {
        return (String) getValue("sVariantb");
    }
