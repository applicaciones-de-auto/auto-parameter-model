 ...
 * @author Arsiela
 */
public class Model_Vehicle_Model_Frame_Pattern implements GEntity {

    final String XML = "Model_Vehicle_Model_Frame_Pattern.xml";
     ...
     */
    public Model_Vehicle_Model_Frame_Pattern(GRider foValue) {
        if (foValue == null) {
    ...
    public String getTable() {
        return "vehicle_model_frame_pattern";
    }
     ...
     * @return result as success/failed
     */
    public JSONObject setFrmeLen(Integer fnValue) {
        return setValue("nFrmeLenx", fnValue);
    }
