 ...
 * @author Arsiela
 */
public class Model_Parts_Brand implements GEntity {

    final String XML = "Model_Parts_Brand.xml";
     ...
     */
    public Model_Parts_Brand(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Parts_Brand loOldEntity = new Model_Parts_Brand(poGRider);
