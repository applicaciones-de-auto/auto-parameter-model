 ...
 * @author Arsiela
 */
public class Model_Activity_Source implements GEntity {

    final String XML = "Model_Activity_Source.xml";
     ...
     */
    public Model_Activity_Source(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject openRecord(String fsCondition) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, " sActTypID = " + SQLUtil.toSQL(fsCondition));
    ...
    public JSONObject saveRecord() {
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Activity_Source loOldEntity = new Model_Activity_Source(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getActTypID());

                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sActTypID = " + SQLUtil.toSQL(this.getActTypID()));
