 ...
 * @author Arsiela
 */
public class Model_Vehicle_Description implements GEntity {

    final String XML = "Model_Vehicle_Description.xml";
     ...
     */
    public Model_Vehicle_Description(GRider foValue) {
        if (foValue == null) {
    ...
    public JSONObject newRecord() {
        ...
        setVhclID(MiscUtil.getNextCode(getTable(), "sVhclIDxx", false, poGRider.getConnection(), poGRider.getBranchCode()+"VM"));
    ...
    public JSONObject saveRecord() {
        String lsExclude = "sMakeDesc»sModelDsc»sColorDsc»sTypeDesc";
        poJSON = new JSONObject();
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                Model_Vehicle_Description loOldEntity = new Model_Vehicle_Description(poGRider);

                //replace with the primary key column info
                JSONObject loJSON = loOldEntity.openRecord(this.getVhclID());
